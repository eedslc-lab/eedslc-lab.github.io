...
class HTTPRequestHandler(BaseHTTPRequestHandler):
    def _send_cors_headers(self):
        ...
        self.send_header('Access-Control-Allow-Methods', 'GET, POST, PUT, OPTIONS')  # Allows specified methods
        self.send_header('Access-Control-Allow-Headers', 'Content-Type')  # Allows specified headers
    
    # Need to override this method for CORS sharing
    def do_OPTIONS(self):
